...
import type TimelineContent from '../types/TimelineContent'
...
export const loadTimelineData = createAsyncThunk(
...
export const timelineSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      .addCase(loadTimelineData.fulfilled, (state, action: PayloadAction<TimelineContent[]>) => {
...
export const getTimelineData = (state: AppState) => state.timeline.timelineContent
